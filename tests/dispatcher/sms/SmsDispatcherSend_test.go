...
func (s *SmsDispatcherSendShould) TestSmsDispatcherSend_ValidMessageToGetSeveralSms_ReturnSuccess() {
	s.clientMock.On(
		"SendRequestFor",
		mock.MatchedBy(testUtil.PassAnyObject),
		mock.MatchedBy(testUtil.PassAnyObject),
	).Return(responseStub.GetSmsSendSuccessResponseList(), nil)
...
func (s *SmsDispatcherSendShould) TestSmsDispatcherSend_ValidMessageToGetSingleSms_ReturnSuccess() {
	s.clientMock.On(
		"SendRequestFor",
		mock.MatchedBy(testUtil.PassAnyObject),
		mock.MatchedBy(testUtil.PassAnyObject),
	).Return(responseStub.GetSmsSendSuccessResponse(), nil)
