...
func (d *SmsDispatcher) Status(ctx context.Context, id int) (*smsModel.Sms, error) {
	...
	description, err := smsDeserializer.UnmarshalStatusResponseToSms(resp)
	if err != nil {
		return nil, err
	}
...
func (d *SmsDispatcher) Send(ctx context.Context, sms *smsModel.SmsMessage) (smsModel.SmsList, error) {
...
func (d *SmsDispatcher) List(ctx context.Context, filter *smsModel.SmsFilter) (*smsModel.FilteredSmsList, error) {
	...
	messageList, err := smsDeserializer.UnmarshallListResponseToFilteredSmsList(resp)
...
func (d *SmsDispatcher) prepareParamsForGetDescriptionList(filter *smsModel.SmsFilter) *apiRequest.RequestParameters {
...
func (d *SmsDispatcher) prepareParamsForSend(sms *smsModel.SmsMessage) *apiRequest.RequestParameters {
